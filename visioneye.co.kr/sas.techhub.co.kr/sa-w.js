var _nSA = (_nSA || {});
_nSA.UPID = '1788917396525851929';
window['_LA'] = window['_LA'] || function() {
    (window['_LA'].q = window['_LA'].q || []).push(arguments)
};
_LA('DMN', 'https://teralog.techhub.co.kr');
_LA('GC', 'TR10202205871');
...
(function() {
    ...
    var q = {
        ...
        B = function(a) {
            for (var b = (new Date).getTime(); new Date <
                b + 1E3 * a;);
            return !0
        },
        x = function(a, b, c) {
        ...
        H = function() {
            ...
            a.push("la_scid=" + w(q.get("_t_scid")));
            a.push("la_suid=" + w(q.get("_t_suid")));
            return a
        },
        w = function(a) {
            return null == a ? "" : a
        ...
        D = function() {
            ...
            B(.1);
            if (m.AL)
                for (var a = p.getElementsByTagName("a"), b = 0, c =
                        a.length; b < c; b++)
                    if (a[b].href && m.AL.indexOf(a[b].href.split(":")[0]) + 1) {
                        var f = a[b],
                            e = I;
                        n.addEventListener ? f.addEventListener("mousedown", e, !1) : n.attachEvent ? f.attachEvent("onmousedown", e) : f.onmousedown = e
                    }
            m.VIEW && k.VW();
            m.IS && C(m.IS);
            m.PC && k.PC(m.PC[0], m.PC[1])
        },
        E = function(a, b, c) {
            if (null != h && "" != h) {
        ...
        k = {
            ...
            INIT: function(a, b, c, f, e, g) {
                m[a] = m[a] || [];
                !isNaN(f) && !isNaN(e) && 0 <= f && 0 < e && (b = (b + "").replace(/\t/gi, " "), c = (c + "").replace(/\t/gi, " "), m[a].push({
                    id: b,
                    nm: c,
                    amt: f,
                    qty: e,
            ...
            SET: function(a, b, c, f) {
                ...
                for (var e = [], g = 0, y = 0, d = c.length; y < d; y++)
                    for (var h = 0, l = a.length; h < l; h++) {
                        var k = a[h];
                        k.id === c[y] && (e[g] = k, e[g].qty = "undefined" === typeof f[y] ? e[g].qty : f[y], g++)
                    }
                return {
                    object: b,
                    product: e
            ...
            VW: function() {
                var a = k.SET("VIEW", k.OBJECT.view);
                a.product = m.VIEW || [];
                u(null, "ec", k.PARAM(a))
            },
            CI: function(a, b) {
                a = k.SET("VIEW", k.OBJECT.cart, a, b);
                a.action = k.ACTION.cartIn;
                u(null, "ec", k.PARAM(a))
            },
            CO: function(a, b) {
                a = k.SET("CART", k.OBJECT.cart, a, b);
                a.action = k.ACTION.cartOut;
                u(null, "ec", k.PARAM(a))
            },
            CD: function(a) {
                a = k.SET("CART", k.OBJECT.cart, a);
                a.action = k.ACTION.cartDelete;
                u(null, "ec", k.PARAM(a))
            },
            CR: function() {
                var a = k.SET("CART", k.OBJECT.cart);
                a.product = m.CART || [];
                a.action = k.ACTION.cartClear;
                u(null, "ec", k.PARAM(a))
            },
            PC: function(a, b) {
                var c = k.SET("PRCH", k.OBJECT.purchase);
                c.product = m.PRCH || [];
                c.amount = a;
                c.pay_type = b;
                c.type = k.TYPE.cart;
        ...
        J = {
            ...
            isSupported: function() {
                ...
                return null != a.getContext && null != a.getContext("2d")
            },
            ...
            getScreenPrint: function() {
                return screen.width + screen.height + screen.availWidth + screen.availHeight +
                    screen.deviceXDPI + screen.deviceYDPI + screen.deviceYDPI
            },
            getPlugins: function() {
            ...
            x64Rotl: function(a, b) {
                ...
                if (32 >
                    b) return [a[0] << b | a[1] >>> 32 - b, a[1] << b | a[0] >>> 32 - b];
                b -= 32;
            ...
            x64hash128: function(a, b) {
                ...
                var c = a.length % 16,
                    ...
                    e = [0, b];
                b = [0, b];
                for (var g, d, h = [2277735313, 289559509], k = [1291169091, 658871167], l = 0; l < f; l += 16) g = [a.charCodeAt(l + 4) & 255 | (a.charCodeAt(l + 5) & 255) << 8 | (a.charCodeAt(l + 6) & 255) << 16 | (a.charCodeAt(l + 7) & 255) << 24, a.charCodeAt(l) & 255 | (a.charCodeAt(l + 1) & 255) << 8 | (a.charCodeAt(l + 2) & 255) << 16 | (a.charCodeAt(l + 3) & 255) << 24], d = [a.charCodeAt(l + 12) & 255 | (a.charCodeAt(l + 13) & 255) << 8 | (a.charCodeAt(l + 14) & 255) << 16 | (a.charCodeAt(l + 15) & 255) << 24, a.charCodeAt(l + 8) & 255 | (a.charCodeAt(l + 9) & 255) << 8 | (a.charCodeAt(l +
                ...
                switch (c) {
                    case 15:
                        d = this.x64Xor(d, this.x64LeftShift([0, a.charCodeAt(l + 14)],
                            48));
                    case 14:
                        d = this.x64Xor(d, this.x64LeftShift([0, a.charCodeAt(l + 13)], 40));
                    case 13:
                        d = this.x64Xor(d, this.x64LeftShift([0, a.charCodeAt(l + 12)], 32));
                    case 12:
                        d = this.x64Xor(d, this.x64LeftShift([0, a.charCodeAt(l + 11)], 24));
                    case 11:
                        d = this.x64Xor(d, this.x64LeftShift([0, a.charCodeAt(l + 10)], 16));
                    case 10:
                        d = this.x64Xor(d, this.x64LeftShift([0, a.charCodeAt(l + 9)], 8));
                    case 9:
                        d = this.x64Xor(d, [0, a.charCodeAt(l + 8)]), d = this.x64Multiply(d, k), d = this.x64Rotl(d, 33), d = this.x64Multiply(d, h), b = this.x64Xor(b, d);
                    case 8:
                        g = this.x64Xor(g,
                            this.x64LeftShift([0, a.charCodeAt(l + 7)], 56));
                    case 7:
                    ...
                    case 1:
                        g = this.x64Xor(g, [0, a.charCodeAt(l)]), g = this.x64Multiply(g,
                            h), g = this.x64Rotl(g, 31), g = this.x64Multiply(g, k), e = this.x64Xor(e, g)
                }
                ...
                e = this.x64Add(e, b);
                b = this.x64Add(b, e);
                return ("00000000" + (e[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (e[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[1] >>> 0).toString(16)).slice(-8)
            }
        };
    try {
        (function() {
            ...
            r = J.getFid();
            for (var b =
                    0, c = a ? a.length : 0; b < c; b++) {
                var f = a[b][0],
                    e = a[b][1];
                "DMN" === f ? d = e : "GC" === f ? h = e : "CDGC" === f ? A = e : "AL" === f ? m.AL = e : "VIEW" === f || "CART" === f || "PRCH" === f ? 5 === e.length && k.INIT(f, t(e[0]), t(e[1]), e[2], e[3], e[4]) : "IS" === f ? m.IS = e : "PC" === f ? (m.PC = [], 3 === a[b].length ? (m.PC.push(a[b][1]), m.PC.push(a[b][2])) : m.PC.push(a[b][1])) : "CRF" === f ? m.CRF = e : "FDC" === f && (m.FDC = e)
            }
            a = p.getElementsByTagName("script")[0];
