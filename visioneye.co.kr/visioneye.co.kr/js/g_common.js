if (typeof(COMMON_JS) == 'undefined') { // 한번만 실행
    ...
    document.write('<script type="text/javascript" src="/js/css_browser_selector.min.js">\x3C/script>');
    //document.write('<script type="text/javascript" src="/js/css3-mediaqueries.js">\x3C/script>');
}

function popup_open(popup, href) {
    popup_close();
    $('body').append('<div id="inner_bg"></div>');
    $('body').append('<div id="inner_bg_fix"></div>');
...
function popup_close() {
    $('#inner_bg, #inner_bg_fix').remove();
}

function bg_loading() {
    popup_close();
    $('body').append('<div id="inner_bg"></div>');
    $('#inner_bg').height($(document).height()).html('<img src="/img/ajax-loader.gif" style="position:fixed;left:50%;top:50%">');
}
...
(function() {
    ...
    window.addEventListener("load", function() {
        c(b.querySelectorAll("a#header_skip")).forEach(function(a) {
            a.addEventListener("click", function() {
                var a = b.getElementById(this.href.split("#")[1]),
                    c = a.getAttribute("tabindex"),
                    e = b.defaultView.getComputedStyle(a, null).getPropertyValue("outline-width");
                a.setAttribute("tabindex", 0);
                a.style.outlineWidth = 0;
                a.focus();
                if (c === null) a.removeAttribute("tabindex");
                else a.setAttribute("tabindex", c)
            }, false)
        })
    }, false)
})();